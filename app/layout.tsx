...
export const metadata = {
  title: "Furkan | Personal Portfolio",
  description:
    "Furkan is a full-stack developer with just a year of experience.",
};
